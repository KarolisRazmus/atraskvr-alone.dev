...
class ResourcesSeeder extends Seeder
{
    ...
    public function run()
    {
        $list = [
            ...
            ["id" => Uuid::uuid4(), "mime_type" => "image/jpeg", "path" => "upload/2017/06/12/1497268016_tilt_brush.jpg", "size" => "67058"], // Manage everything
            ["id" => Uuid::uuid4(), "mime_type" => "image/jpeg", "path" => "upload/2017/06/12/1497268016_hurl.jpg", "size" => "85379"], // Manage everything
